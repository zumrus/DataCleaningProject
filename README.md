...
```
git clone https://github.com/zumrus/DataCleaningProject
```
...
Использованные данные хорошо подходят для демонстрации различных методов очистки. Вместе с тем, они дают понять, что на них нельзя слепо погалаться и при работе с выбросами следует руководствоваться в том числе здравым смыслом. 